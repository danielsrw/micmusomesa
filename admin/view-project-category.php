                                ...
                                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                                    ...
                                    <div>
                                        <div class="btn-wrapper">
                                            <a href="add-project-category.php" class="btn btn-primary text-white me-0">
                                                <i class="icon-plus"></i> Add Project Category
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <tbody>
                                            <?php
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="edit-project-category.php?id=<?php echo $row['id']; ?>">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <p>
                                                                    Are you sure you want to delete this project category (<?php echo $row['name'] ?>)
                                                                </p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-danger" href="delete-project-category.php?id=<?php echo $row['id']; ?>">Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
