                                ...
                                <div class="d-sm-flex align-items-center justify-content-between border-bottom mb-3">
                                    ...
                                    <div>
                                        <div class="btn-wrapper">
                                            <a href="view-background-home.php" class="btn btn-primary text-white me-0">
                                            ...
                                            <div class="card-body">
                                                <form class="forms-sample" action="#" method="POST" enctype="multipart/form-data">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-9">
                                                            <input type="hidden" name="current_photo" value="./assets/uploads/backgrounds/<?php echo $row['homeImage']; ?>">
                                                            <img src="./assets/uploads/backgrounds/<?php echo $row['homeImage']; ?>" style="width: 100px;">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">New Image</label>
                                                        <div class="col-sm-9">
                                                            <input type="file" name="homeImage" class="form-control mt-2">
                                                        </div>
                                                    </div>
                                                    <button type="submit" name="update-home-image" class="btn btn-primary me-2 text-white">
                                                        Update Image
                                                    </button>
