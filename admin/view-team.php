                                ...
                                <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                                    ...
                                    <div>
                                        <div class="btn-wrapper">
                                            <a href="add-team.php" class="btn btn-primary text-white me-0">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover" id="dataTable">
                                        ...
                                        <tbody>
                                            <?php
                                                $i=0;
                                                $statement = $pdo->prepare("SELECT * FROM teams ORDER BY id DESC");
                                                $statement->execute();
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="./assets/uploads/team/<?php echo $row['image']; ?>">
                                                    </td>
                                                    <td>
                                                        <?php if ($row['status'] == 1): ?>
                                                            <a href="#">
                                                    ...
                                                    <td>
                                                        <a href="edit-team.php?id=<?php echo $row['id']; ?>">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-body">
                                                                <p>
                                                                    Are you sure you want to delete this team member (<?php echo $row['name'] ?>)
                                                                </p>
                                                            </div>
                                                            <div class="modal-footer">
                                                                ...
                                                                <a class="btn btn-danger" href="delete-team.php?id=<?php echo $row['id']; ?>">Delete</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
